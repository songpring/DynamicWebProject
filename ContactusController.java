...
class Contactus extends CI_Controller {
	...
	public function register() {
		if(!$this->input->post('name', TRUE)) header('Location: /contactus');

		$this->load->model('contactus_model');
		$arr_key = array('name', 'nationality','phonenumber','birthday','sns', 'instagram','uploadfiles');
		$extends_var = '';
		...
		$data['result'] = $result;
		header('Location: /contactus/complete');
		//$this->load->view('contactus/complete', $data);
	}

	public function complete() {
		$this->load->view('contactus/complete');
	}
	...
	public function set() {
		...
		$this->load->view('contactus/set-form');
	}
