...
<body id="page-top">
	...
	<header class="masthead">
		...
		<video class="main-vid" playsinline="playsinline" autoplay="autoplay" muted="muted"
			loop="loop">
	...
	<!-- Portfolio section 여기를 좁아지면 display: none 으로 변경 -->
			...
			<div class="row no-gutters">
				...
				<div class="col-lg-4 col-xs-3">
					<a class="portfolio-box"
						> <!-- <img
						class="img-fluid"
						src="img/portfolio/audition.jpg" alt="" /> -->
				...
				<!-- <div class="col-lg-4 col-xs-6">
					<a class="portfolio-box"
						href="img/portfolio/fullsize/4.jpg"><img
						class="img-fluid"
						src="img/portfolio/thumbnails/4.jpg" alt="" />
						<div class="portfolio-box-caption">
							<div class="project-category text-white-50">Category</div>
				...
				<div class="col-lg-4 col-xs-6">
					<a class="portfolio-box"
						href="img/portfolio/fullsize/5.jpg"><img
						class="img-fluid"
						src="img/portfolio/thumbnails/5.jpg" alt="" />
						<div class="portfolio-box-caption">
							<div class="project-category text-white-50">Category</div>
							<div class="project-name">Project Name</div>
						</div></a>
				...
				<div class="col-lg-4 col-xs-6">
					<a class="portfolio-box"
						href="img/portfolio/fullsize/6.jpg"><img
						class="img-fluid"
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
					...
					<div class="font-korean-content"><a href="tel:+825551234567">+82 (555) 123-4567</a></div>
				</div>
				<div class="col-lg-4 mr-auto text-center">
					<i class="fas fa-envelope fa-3x mb-3 text-muted"></i> <a
						class="d-block font-korean-content" href="mailto: gfun.corp@gmail.com">gfun.corp@gmail.com</a>
				</div>
			</div>
		</div>
	</section>
	...
	<!-- footer-big end -->
	<!-- Footer small start-->
	<footer class="bg-light py-5 footer-small">
		<!-- Footer Links -->
		<div class="container-fluid text-center">
		...
		<div class="container">
			...
			<div class="small text-center text-muted mg-top">© 2020
				Gfun</div>
		</div>
	</footer>
	<!-- footer-small end -->
